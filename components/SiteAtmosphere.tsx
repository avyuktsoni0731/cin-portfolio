...
export function SiteAtmosphere() {
  return (
    <>
      ...
      <div
        className="pointer-events-none fixed inset-0 z-0 bg-[radial-gradient(ellipse_100%_60%_at_50%_-25%,oklch(0.32_0.07_290_/_0.1),transparent_55%),radial-gradient(ellipse_80%_50%_at_100%_0%,oklch(0.28_0.05_220_/_0.06),transparent_50%),radial-gradient(ellipse_60%_40%_at_0%_100%,oklch(0.25_0.04_160_/_0.05),transparent_45%)]"
        aria-hidden
      />
      {/* Emerald lift at bottom — echoes GitHub activity without shouting */}
      <div
        className="pointer-events-none fixed inset-0 z-0 bg-[radial-gradient(ellipse_90%_45%_at_50%_120%,oklch(0.22_0.05_165_/_0.08),transparent_50%)]"
        aria-hidden
      />
